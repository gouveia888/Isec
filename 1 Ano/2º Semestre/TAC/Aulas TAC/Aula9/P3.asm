...
CODE_HERE segment
	...
	Main proc
		...
		lea si, lo_num 	;registo s1 como ponteiro para os dados de entrada 
		lea di, average	;registo di como ponteiro para o incio das variaveeis de saida 
		call MEDIA		
...
Main endp
		;Calculo da media paramentos de entrada (lo_num,hi_num) parametro de saida (average)
