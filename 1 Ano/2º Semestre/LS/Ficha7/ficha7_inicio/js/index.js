...
/*function LinguagensScript({nome}) {
     return <h1 style={styleH1}> ola {nome} bem vindo a Linguagens Script!</h1>
}

const LinguagensScript2 = ({prop}) => <h1 style={styleH1}>ola {prop.nome}</h1>;
...
const styleH1 = {
 ...
 <React.StrictMode>
          <LinguagensScript nome="manel"/>
          <LinguagensScript nome="Tiago" />
          <LinguagensScript nome="Maria"/>
          <LinguagensScript nome="joana"/>
</React.StrictMode >
...
function InfoComponent(prop){
     ...
     return (
               <div className="wrapper">
                    <div className="logo">
                         <img src={`images/${prop.src}`} alt="React" />
                    </div>
                    <div className="text">
                         <h2>{prop.title}</h2>
                         <p>{prop.children}</p>
                         <a href={prop.url} target="_blank">Ler mais</a>
                    </div>
               </div>
     );
...
root.render(
     <React.StrictMode>
          <div className="container">
               <InfoComponent title="React" url="https://reactjs.dev/" src="react.png">
               ...
               object-oriented, imperative, and declarative (e.g. functional programming) styles. Read more about JavaScript.
               </InfoComponent>
