...
//pedir ao tilizador o tempo e nao as threads
//TODO criar um waitbelTimer(NULL, FALSE, NULL) comparar o handler com null se = return 0
//setwaitbel timer ()
...
DWORD WINAPI Multiplos(LPVOID pdados) {
	...
	liDueTime.QuadPart = segundos * -10000000LL;
	hTimer = CreateWaitableTimer(NULL, FALSE, NULL);
	if (hTimer == NULL)
		return 0;
	_tprintf(_T("Esperar %u segundos...\n\n"), segundos);

	SetWaitableTimer(hTimer, &liDueTime, 0, fimTempo, &timerData, 0);
