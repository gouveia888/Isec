    ...
    [
      ...
      ifelse [pcolor] of patch-ahead 1 = red
        ...
        [ifelse [pcolor] of patch-ahead 1 = blue
          ...
          [ifelse nErva = capMax and localX != 1000 and localY != 1000
            [procura-ninho
            show "procurar ninho"]
...
to procura-ninho
 ...
 ifelse (ycor < localY and heading = 0) or (xcor < localX and heading = 90) or (ycor > localY and heading = 180) or (xcor > localX and heading = 270)
 [fd 1]
 [
 ifelse (ycor = localY and heading = 0 and xcor < localX) or (ycor = localY and heading = 180 and xcor > localX) or (xcor = localX and heading = 90 and ycor > localY) or (xcor = localX and heading = 270 and ycor < localY) or (xcor = localX and heading = 0 and ycor > localY)
 [rt 90]
 [
 ifelse (ycor = localY and heading = 0 and xcor > localX) or (ycor = localY and heading = 180 and xcor < localX) or (xcor = localX and heading = 90 and ycor < localY) or (xcor = localX and heading = 270 and ycor > localY) or (xcor = localX and heading = 180 and ycor < localY)
 [lt 90]
 [
...
to ChangeArmadilhas
  ask patches with [pcolor = red][
    ask one-of patches with [not any? turtles-here and pcolor != green and pcolor != red and pcolor != blue and pcolor != yellow]
       [set pcolor red]
    set pcolor black
  ]
end
...
to reproduction
  ask formigas[
    if energia > birthenergy and random 100 < reproductionFormigas
    [
      set energia energia / 2
      hatch 1 [jump 5] ;hatch 1 cria x colones
    ]
  ]

  ask caracois[
    if energia > birthenergy and random 100 < reproductionCaracois
    [
      set energia energia / 2
      hatch 1 [jump 5] ;hatch 1 cria x colones
    ]
...
to competition
  ask formigas[
    if any? formigas-on neighbors4
      [
        let y energia
        let x max-one-of formigas-on neighbors4 [energia] ;;escolhe uma formiga
        ifelse energia > [energia] of x ;;energia da formiga e maior do que a formiga a ser questionada
        [
          set energia energia + [energia] of x ;;absorve energia da mais fraca
          ask x [die]
        ]
        [
          ask x [set energia energia + y]
          die
        ]
      ]
  ]
  ...
  ask formigas[
    if any? caracois-on neighbors4
      [
        let y energia
        let x max-one-of caracois-on neighbors4 [energia] ;;escolhe uma formiga
        ifelse energia > [energia] of x ;;energia da formiga e maior do que a formiga a ser questionada
        [
          set energia energia + [energia] of x ;;absorve energia da mais fraca
          ask x [die]
