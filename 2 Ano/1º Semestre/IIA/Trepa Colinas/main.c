...
#define MAX_NOME_FICHEIRO 100
int main(int argc, char *argv[])
{
    char    nome_fich[MAX_NOME_FICHEIRO];
	...
	if(argc == 3)
	{
        ...
        else
        {
            ...
            fgets(nome_fich,MAX_NOME_FICHEIRO,stdin); //scanf
	...
	for(k=0; k<runs; k++)
	{
        ...
        //custo= trepa_colinas_prop(sol, grafo, vert, num_iter);
        // recristalizacao simulada
        custo = recristalizacao_simulada(sol, grafo, vert);
