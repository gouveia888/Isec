...
//TCP versao iterativa concorrente
    ...
    public void run() {
        ...
        try(BufferedReader bin = new BufferedReader(new InputStreamReader(socket.getInputStream()))) { //2 (atendimento cliente)
            ...
            try {
                ...
                System.out.println("Ocorreu a excepcao {" + e + "} ao tentar fechar o socket do cliente!");
            }
        }
    }
}
    ...
    public static void main(String[] args) {
        ...
        try(ServerSocket serverSocket = new ServerSocket(Integer.parseInt(args[0]))) { // 1
            ...
            while (true) {
                ...
                new ProcessClientThread(socket, localDirectory).start();
