...
public class GetRemoteFileService extends UnicastRemoteObject implements GetRemoteFileInterface{
    ...
    public long getFileSize(String filename) throws IOException {
        ...
        if(!requestedCanonicalFilePath.startsWith(localDirectory.getCanonicalPath()+File.separator)){
            String msg = "Nao é permitido aceder ao ficheiro" + filename + "!\n";
            msg += "A diretoria da base nao corresponde a " + localDirectory.getCanonicalPath() + "!";
        ...
        try{
            ...
            if(offset==0){
                try{
                    ...
                    System.out.println("Metedo invocado pelo cliente " + getClientHost());
